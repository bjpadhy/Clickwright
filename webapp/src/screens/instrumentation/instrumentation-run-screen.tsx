...
export function InstrumentationRunScreen() {
  ...
  // Any closed gate is worth a trail — keying this on the DDL gate alone hid
  // the record for optimization runs, which never have one.
  const anyDecided = model.approvals.length > 0
              ...
              <Textarea
                ...
                placeholder={
                  gate === "ddl"
                    ...
                    : gate === "optimization"
                      ? "e.g. use a TTL of 12 months, not 6 — finance needs the history"
